...
enum CharacterSize: String, CaseIterable {
    ...
    var displayName: String {
        switch self {
        case .large: return NSLocalizedString("Large", comment: "Size option")
        case .medium: return NSLocalizedString("Medium", comment: "Size option")
        case .small: return NSLocalizedString("Small", comment: "Size option")
        }
    }
}
...
class WalkerCharacter {
    ...
    func createPopoverWindow() {
        ...
        arrowBtn.image = NSImage(systemSymbolName: "chevron.down", accessibilityDescription: NSLocalizedString("Switch provider", comment: "Accessibility"))
        ...
        refreshBtn.image = NSImage(systemSymbolName: "arrow.clockwise", accessibilityDescription: NSLocalizedString("Refresh", comment: "Accessibility"))
        ...
        copyBtn.image = NSImage(systemSymbolName: "square.on.square", accessibilityDescription: NSLocalizedString("Copy", comment: "Accessibility"))
    ...
    private func wireSession(_ session: any AgentSession) {
        ...
        session.onProcessExit = { [weak self] in
            guard let self = self else { return }
            self.terminalView?.endStreaming()
            self.terminalView?.appendError(String(format: NSLocalizedString("%@ session ended.", comment: "Session ended message"), self.provider.displayName))
        }
    ...
    private static let thinkingPhrases = [
        NSLocalizedString("hmm...", comment: "Thinking phrase"),
        NSLocalizedString("thinking...", comment: "Thinking phrase"),
        NSLocalizedString("one sec...", comment: "Thinking phrase"),
        NSLocalizedString("ok hold on", comment: "Thinking phrase"),
        NSLocalizedString("let me check", comment: "Thinking phrase"),
        NSLocalizedString("working on it", comment: "Thinking phrase"),
        NSLocalizedString("almost...", comment: "Thinking phrase"),
        NSLocalizedString("bear with me", comment: "Thinking phrase"),
        NSLocalizedString("on it!", comment: "Thinking phrase"),
        NSLocalizedString("gimme a sec", comment: "Thinking phrase"),
        NSLocalizedString("brb", comment: "Thinking phrase"),
        NSLocalizedString("processing...", comment: "Thinking phrase"),
        NSLocalizedString("hang tight", comment: "Thinking phrase"),
        NSLocalizedString("just a moment", comment: "Thinking phrase"),
        NSLocalizedString("figuring it out", comment: "Thinking phrase"),
        NSLocalizedString("crunching...", comment: "Thinking phrase"),
        NSLocalizedString("reading...", comment: "Thinking phrase"),
        NSLocalizedString("looking...", comment: "Thinking phrase"),
        NSLocalizedString("cooking...", comment: "Thinking phrase"),
        NSLocalizedString("vibing...", comment: "Thinking phrase"),
        NSLocalizedString("digging in", comment: "Thinking phrase"),
        NSLocalizedString("connecting dots", comment: "Thinking phrase"),
        NSLocalizedString("give me a sec", comment: "Thinking phrase"),
        NSLocalizedString("don't rush me", comment: "Thinking phrase"),
        NSLocalizedString("calculating...", comment: "Thinking phrase"),
        NSLocalizedString("assembling…", comment: "Thinking phrase")
    ]

    private static let completionPhrases = [
        NSLocalizedString("done!", comment: "Completion phrase"),
        NSLocalizedString("all set!", comment: "Completion phrase"),
        NSLocalizedString("ready!", comment: "Completion phrase"),
        NSLocalizedString("here you go", comment: "Completion phrase"),
        NSLocalizedString("got it!", comment: "Completion phrase"),
        NSLocalizedString("finished!", comment: "Completion phrase"),
        NSLocalizedString("ta-da!", comment: "Completion phrase"),
        NSLocalizedString("voila!", comment: "Completion phrase"),
        NSLocalizedString("boom!", comment: "Completion phrase"),
        NSLocalizedString("there ya go!", comment: "Completion phrase"),
        NSLocalizedString("check it out!", comment: "Completion phrase")
    ]
