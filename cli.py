    ...
    async def handle_smart_request(self, request: str):
        ...
        try:
            ...
            if not result.get("success"):
                step_display.set_step_failed(2)
                step_display.display()
            ...
            step_display.set_step_failed(1)
            step_display.display()
            think_complete(2, success=False, error=str(e))
    ...
    def _display_workflow_result(self, result: Dict[str, Any]):
        ...
        if results:
            ...
            for step_result in results:
                ...
                print(f"    {status} 步骤{step_num} [{step_type}]")
                ...
                if step_result.get("csv_path"):
                    print(f"      文件: {step_result['csv_path']}")
