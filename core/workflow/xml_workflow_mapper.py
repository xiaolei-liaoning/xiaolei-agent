...
from ..security.error_handler import (
    ErrorHandlerUtils, retry_on_error, handle_errors_with_default as handle_errors
)
...
class XMLWorkflowMapper:
    ...
    def __init__(self):
        ...
        try:
            ...
            ErrorHandlerUtils.log_error(e, module=__name__, function="__init__", extra_info="XML Schema编译失败")
    ...
    def _validate_xml_schema_cached(self, xml_content_hash: int):
        ...
        try:
            ...
            ErrorHandlerUtils.log_error(e, module=__name__, function="_validate_xml_schema")
    ...
    def parse_xml_workflow(self, xml_content: str) -> Dict[str, Any]:
        ...
        try:
            ...
            ErrorHandlerUtils.log_error(e, module=__name__, function="parse_xml_workflow", extra_info="XML解析失败")
            return {
                "success": False,
                "error": f"XML解析错误: {e}"
            }
        except Exception as e:
            ErrorHandlerUtils.log_error(e, module=__name__, function="parse_xml_workflow", extra_info="XML工作流映射失败")
            return {
                "success": False,
                "error": f"映射失败: {e}"
            }
    ...
    def _map_node(self, node_elem: ET.Element) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            ErrorHandlerUtils.log_error(e, module=__name__, function="_map_node", extra_info=f"节点ID: {node_elem.attrib.get('id', 'unknown')}")
            return None
    ...
    def _map_edge(self, edge_elem: ET.Element) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            ErrorHandlerUtils.log_error(e, module=__name__, function="_map_edge")
            return None
